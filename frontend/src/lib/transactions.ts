...
export const SAVINGS_CIRCLE_ADDRESS = (process.env.NEXT_PUBLIC_SAVINGS_CIRCLE_ADDRESS || "0xEf2BF49C0394560384301A209c8793160B3D2ac8") as Address;
export const GIFT_ESCROW_ADDRESS = (process.env.NEXT_PUBLIC_GIFT_ESCROW_ADDRESS || "0x72425B766F61a83da983c1908460DF118FA125Ad") as Address;
